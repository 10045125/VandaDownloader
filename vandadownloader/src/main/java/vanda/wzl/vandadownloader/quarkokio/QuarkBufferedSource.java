 ...
 *  Description :BufferedSource.java
 *
 *  Creation    : 2017-06-03
 ...
 * input.
 */
public interface QuarkBufferedSource extends QuarkSource {
   ...
   */
  void readFully(QuarkBuffer sink, long byteCount) throws IOException;
   ...
   */
  long readAll(QuarkSink sink) throws IOException;
