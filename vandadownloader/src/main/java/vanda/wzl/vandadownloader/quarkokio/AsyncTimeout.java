...
public class AsyncTimeout extends Timeout {
   ...
   */
  public final QuarkSink sink(final QuarkSink sink) {
    return new QuarkSink() {
      @Override
      public void write(QuarkBuffer source, long byteCount) throws IOException {
   ...
   */
  public final QuarkSource source(final QuarkSource source) {
    return new QuarkSource() {
      @Override
      public long read(QuarkBuffer sink, long byteCount) throws IOException {
        boolean throwOnTimeout = false;
        enter();
        try {
