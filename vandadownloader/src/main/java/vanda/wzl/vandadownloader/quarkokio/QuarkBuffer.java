...
import static vanda.wzl.vandadownloader.quarkokio.Util.checkOffsetAndCount;
import static vanda.wzl.vandadownloader.quarkokio.Util.reverseBytesLong;
 ...
 */
public final class QuarkBuffer implements QuarkBufferedSource, QuarkBufferedSink, Cloneable {
    ...
    public OutputStream outputStream() {
        return new OutputStream() {
            ...
            public void write(byte[] data, int offset, int byteCount) {
                QuarkBuffer.this.write(data, offset, byteCount);
            }
            ...
            public String toString() {
                return QuarkBuffer.this + ".outputStream()";
            }
        };
    }
    ...
    @Override
    public QuarkBuffer emitCompleteSegments() {
        return this; // Nowhere to emit to!
    }

    @Override
    public QuarkBufferedSink emit() {
        return this; // Nowhere to emit to!
    }
    ...
    public InputStream inputStream() {
        return new InputStream() {
            ...
            public int read(byte[] sink, int offset, int byteCount) {
                return QuarkBuffer.this.read(sink, offset, byteCount);
            }
            ...
            @Override
            public String toString() {
                return QuarkBuffer.this + ".inputStream()";
            }
        };
    }
     ...
     */
    public QuarkBuffer copyTo(OutputStream out) throws IOException {
     ...
     * {@code out}.
     */
    public QuarkBuffer copyTo(OutputStream out, long offset, long byteCount) throws IOException {
     ...
     */
    public QuarkBuffer copyTo(QuarkBuffer out, long offset, long byteCount) {
        if (out == null) throw new IllegalArgumentException("out == null");
        checkOffsetAndCount(size, offset, byteCount);
        if (byteCount == 0) return this;
     ...
     */
    public QuarkBuffer writeTo(OutputStream out) throws IOException {
     ...
     */
    public QuarkBuffer writeTo(OutputStream out, long byteCount) throws IOException {
        if (out == null) throw new IllegalArgumentException("out == null");
     ...
     */
    public QuarkBuffer readFrom(InputStream in) throws IOException {
     ...
     */
    public QuarkBuffer readFrom(InputStream in, long byteCount) throws IOException {
            ...
            for (; pos < limit; pos++, seen++) {
                ...
                if (b >= '0' && b <= '9') {
                    ...
                    if (value < overflowZone || value == overflowZone && digit < overflowDigit) {
                        QuarkBuffer buffer = new QuarkBuffer().writeDecimalLong(value).writeByte(b);
        ...
        do {
            ...
            for (; pos < limit; pos++, seen++) {
                ...
                if ((value & 0xf000000000000000L) != 0) {
                    QuarkBuffer buffer = new QuarkBuffer().writeHexadecimalUnsignedLong(value).writeByte(b);
                    throw new NumberFormatException("Number too large: " + buffer.readUtf8());
                }
    ...
    @Override
    public void readFully(QuarkBuffer sink, long byteCount) throws EOFException {
        if (size < byteCount) {
    ...
    @Override
    public long readAll(QuarkSink sink) throws IOException {
        long byteCount = size;
        if (byteCount > 0) {
            sink.write(this, byteCount);
        }
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        ...
        QuarkBuffer data = new QuarkBuffer();
    ...
    @Override
    public QuarkBuffer write(ByteString byteString) {
    ...
    @Override
    public QuarkBuffer writeUtf8(String string) {
        return writeUtf8(string, 0, string.length());
    }

    @Override
    public QuarkBuffer writeUtf8(String string, int beginIndex, int endIndex) {
    ...
    @Override
    public QuarkBuffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 0x80) {
    ...
    @Override
    public QuarkBuffer writeString(String string, Charset charset) {
        return writeString(string, 0, string.length(), charset);
    }

    @Override
    public QuarkBuffer writeString(String string, int beginIndex, int endIndex, Charset charset) {
        if (string == null) throw new IllegalArgumentException("string == null");
    ...
    @Override
    public QuarkBuffer write(byte[] source) {
        if (source == null) throw new IllegalArgumentException("source == null");
        return write(source, 0, source.length);
    }

    @Override
    public QuarkBuffer write(byte[] source, int offset, int byteCount) {
        if (source == null) throw new IllegalArgumentException("source == null");
    ...
    @Override
    public QuarkBuffer writeByte(int b) {
        Segment tail = writableSegment(1);
    ...
    @Override
    public QuarkBuffer writeShort(int s) {
    ...
    @Override
    public QuarkBuffer writeShortLe(int s) {
        return writeShort(Util.reverseBytesShort((short) s));
    }

    @Override
    public QuarkBuffer writeInt(int i) {
    ...
    @Override
    public QuarkBuffer writeIntLe(int i) {
        return writeInt(Util.reverseBytesInt(i));
    }

    @Override
    public QuarkBuffer writeLong(long v) {
    ...
    @Override
    public QuarkBuffer writeLongLe(long v) {
        return writeLong(reverseBytesLong(v));
    }

    @Override
    public QuarkBuffer writeDecimalLong(long v) {
        if (v == 0) {
    ...
    @Override
    public QuarkBuffer writeHexadecimalUnsignedLong(long v) {
        if (v == 0) {
            // Both a shortcut and required since the following code can't handle zero.
            return writeByte('0');
        }
    ...
    @Override
    public long read(QuarkBuffer sink, long byteCount) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QuarkBuffer)) return false;
        QuarkBuffer that = (QuarkBuffer) o;
     ...
     */
    @Override
    public QuarkBuffer clone() {
        QuarkBuffer result = new QuarkBuffer();
