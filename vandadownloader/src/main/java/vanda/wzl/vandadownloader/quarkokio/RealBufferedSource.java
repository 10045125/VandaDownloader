 ...
 *  Description :RealBufferedSource.java
 *
 *  Creation    : 2017-06-03
...
final class RealBufferedSource implements QuarkBufferedSource {
  public final QuarkBuffer buffer = new QuarkBuffer();
  public final QuarkSource source;
  boolean closed;

  RealBufferedSource(QuarkSource source) {
    if (source == null) throw new NullPointerException("source == null");
    this.source = source;
  }

  @Override public QuarkBuffer buffer() {
    return buffer;
  }
  ...
  @Override public void readFully(QuarkBuffer sink, long byteCount) throws IOException {
    try {
      require(byteCount);
    } catch (EOFException e) {
      // The underlying source is exhausted. Copy the bytes we got before rethrowing.
  ...
  @Override public long readAll(QuarkSink sink) throws IOException {
    if (sink == null) throw new IllegalArgumentException("sink == null");
