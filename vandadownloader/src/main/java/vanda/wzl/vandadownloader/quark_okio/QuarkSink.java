 ...
 * {@link QuarkBufferedSink} which is both more efficient and more convenient. Use
 * {@link okio.Okio#buffer(okio.Sink)} to wrap any sink with a buffer.
 *
 * <p>Sinks are easy to test: just use a {@link QuarkBuffer} in your tests, and
 ...
 * Use {@link QuarkOkio#sink} to adapt an {@code OutputStream} to a sink. Use {@link
 * QuarkBufferedSink#outputStream} to adapt a sink to an {@code OutputStream}.
 */
public interface QuarkSink extends Closeable, Flushable {
  /** Removes {@code byteCount} bytes from {@code source} and appends them to this. */
  void write(QuarkBuffer source, long byteCount) throws IOException;
